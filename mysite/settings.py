...
SECRET_KEY = 'django-insecure-)v^1-si5h2@ts%j#o-t@!pr_)aq1b41spgvdb8q!wyh$-!#dec' # Not secure way to store secret key
#SECRET_KEY = os.getenv('SECRET_KEY') # Secure way to store secret key
